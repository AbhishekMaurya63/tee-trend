...
const About = () => {
  const teamMembers = [
  {
    ...
    description: 'Visionary leader who laid the foundation of the brand, driving creativity, strategy, and long-term growth.'
  },
  {
    name: 'Anant Maurya',
    role: 'Co-Founder',
    image: 'https://res.cloudinary.com/dpqrvn7ri/image/upload/v1757673048/products/mglbiayd7tymitwbuhvb.jpg',
    description: 'Supports the brand’s mission with innovative ideas, strategic partnerships, and sustainable business practices.'
  },
  {
    name: 'Aadarsh Raj Sonkar',
    role: 'Quality Manager',
    image: '/placeholder.svg',
    description: 'Oversees product quality at every stage, ensuring durability, precision, and excellence in craftsmanship.'
  },
  {
    name: 'Anmol Kushwaha',
    role: 'Technical Manager',
    image: 'https://res.cloudinary.com/dpqrvn7ri/image/upload/v1757672908/products/dw2hcoaqrh6qwnq2b3tb.png',
    description: 'Leads technical operations and innovations, ensuring smooth production processes and advanced solutions.'
  }
];
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'Committed to eco-friendly practices and responsible Comfort production.'
    },
    {
      icon: Users,
      title: 'Community',
    ...
    },
    {
      icon: TrendingUp,
      title: 'Innovation',
      description: 'Continuously evolving to bring you the finest in Comfort fashion.'
    }
  ];

  const milestones = [
    { year: '2018', title: 'Brand Inception', description: 'Founded with a vision to redefine Comfort fashion' },
    { year: '2019', title: 'First Collection', description: 'Launched our debut Comfort collection' },
    { year: '2021', title: 'Global Recognition', description: 'Featured in international fashion publications' },
    { year: '2023', title: 'Eco Initiative', description: 'Introduced sustainable Comfort production line' },
      ...
      <section className="bg-gradient-to-r from-amber-600 to-amber-800 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-amber-100/90 leading-relaxed">
            We craft comfort clothing that embodies elegance, quality, and sustainability. 
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-amber-950 leading-tight">
                  Redefining Comfort Fashion
                </h2>
              </div>
              <p className="text-lg text-amber-800/90 leading-relaxed">
                At AnantAttire, we believe true Comfort lies in the perfect harmony of exceptional quality, 
              ...
              <div className="grid grid-cols-2 gap-8 pt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-amber-700 mb-2">5000</div>
                  <div className="text-sm text-amber-600/80">Comfort Clients</div>
                </div>
                {/* <div className="text-center">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-700/90">
              From visionary beginnings to becoming a symbol of Comfort
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-amber-100/50 to-amber-50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-700/90 max-w-2xl mx-auto">
              Meet the passionate individuals dedicated to redefining Comfort fashion
            </p>
          </div>
